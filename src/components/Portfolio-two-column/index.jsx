        ...
        <div className="gallery full-width">
            ...
            <div className="row">
              <div className="col-lg-10">
                <div className="item-img wow fadeInUp" data-wow-delay=".4s">
                  <Link href="/project-details/project-details-dark">
                    <a>
                      <img src="/img/portfolio/works/9.jpg" alt="image" />
                    </a>
                  </Link>
                  <div className="cont">
                    <h6>Blast From The Past</h6>
          ...
          <div className="col-md-6 items web">
            <div className="item-img wow fadeInUp" data-wow-delay=".4s">
              <Link href="/project-details/project-details-dark">
                <a>
                  <img src="/img/portfolio/works/10.jpg" alt="image" />
                </a>
              </Link>
              <div className="cont">
                <h6>See It Yourself</h6>
            ...
            <div className="row">
              <div className="col-lg-10">
                <div className="item-img wow fadeInUp" data-wow-delay=".4s">
                  <Link href="/project-details/project-details-dark">
                    <a>
                      <img src="/img/portfolio/works/12.jpg" alt="image" />
                    </a>
                  </Link>
                  <div className="cont">
                    <h6>Blast From The Past</h6>
          ...
          <div className="col-md-6 items web">
            <div className="item-img wow fadeInUp" data-wow-delay=".4s">
              <Link href="/project-details/project-details-dark">
                <a>
                  <img src="/img/portfolio/works/11.jpg" alt="image" />
                </a>
              </Link>
              <div className="cont">
                <h6>See It Yourself</h6>
            ...
            <div className="row">
              <div className="col-lg-10">
                <div className="item-img wow fadeInUp" data-wow-delay=".4s">
                  <Link href="/project-details/project-details-dark">
                    <a>
                      <img src="/img/portfolio/works/13.jpg" alt="image" />
                    </a>
                  </Link>
                  <div className="cont">
                    <h6>Blast From The Past</h6>
            ...
            <div className="row">
              <div className="col-lg-10">
                <div className="item-img wow fadeInUp" data-wow-delay=".4s">
                  <Link href="/project-details/project-details-dark">
                    <a>
                      <img src="/img/portfolio/works/16.jpg" alt="image" />
                    </a>
                  </Link>
                  <div className="cont">
                    <h6>Blast From The Past</h6>
          ...
          <div className="col-md-6 items web">
            <div className="item-img wow fadeInUp" data-wow-delay=".4s">
              <Link href="/project-details/project-details-dark">
                <a>
                  <img src="/img/portfolio/works/15.jpg" alt="image" />
                </a>
              </Link>
              <div className="cont">
                <h6>See It Yourself</h6>
            ...
            <div className="row">
              <div className="col-lg-10">
                <div className="item-img wow fadeInUp" data-wow-delay=".4s">
                  <Link href="/project-details/project-details-dark">
                    <a>
                      <img src="/img/portfolio/works/14.jpg" alt="image" />
                    </a>
                  </Link>
                  <div className="cont">
                    <h6>Blast From The Past</h6>
            ...
            <div className="row">
              <div className="col-lg-10">
                <div className="item-img wow fadeInUp" data-wow-delay=".4s">
                  <Link href="/project-details/project-details-dark">
                    <a>
                      <img src="/img/portfolio/works/17.jpg" alt="image" />
                    </a>
                  </Link>
                  <div className="cont">
                    <h6>Blast From The Past</h6>
