                      ...
                      <SwiperSlide className="swiper-slide">
                        ...
                        >
                          <div
                            ...
                            style={{
                              backgroundImage: "url(/img/portfolio/curs/aaaa.jpg)",
                            }}
                          ></div>
                      ...
                      <SwiperSlide className="swiper-slide">
                        ...
                        >
                          <div
                            className="item-img bg-img wow imago"
                            style={{
                              backgroundImage: "url(/img/portfolio/curs/cybart.jpeg)",
                            }}
                          ></div>
                          <div className="cont bgbox">
                            <h6>
                      ...
                      <SwiperSlide className="swiper-slide">
                        ...
                        >
                          <div
                            className="item-img bg-img wow imago"
                            style={{
                              backgroundImage: "url(/img/portfolio/curs/coffee_samir.jpeg)",
                            }}
                          ></div>
                          <div className="cont bgbox">
                            <h6>
                      ...
                      <SwiperSlide className="swiper-slide">
                        ...
                        >
                          <div
                            className="item-img bg-img wow imago"
                            style={{
                              backgroundImage: "url(/img/portfolio/curs/marocarts.jpeg)",
                            }}
                          ></div>
                          <div className="cont bgbox">
                            <h6>
                      ...
                      <SwiperSlide className="swiper-slide">
                        ...
                        >
                          <div
                            className="item-img bg-img wow imago"
                            style={{
                              backgroundImage: "url(/img/portfolio/curs/xspqcesecurity.jpeg)",
                            }}
                          ></div>
                          <div className="cont bgbox">
                            <h6>
